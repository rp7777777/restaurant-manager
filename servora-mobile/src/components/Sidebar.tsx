            ...
            {section.items.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  {isActive && (
                    <View style={[styles.activeBar, { backgroundColor: theme.sidebarActiveText }]} />
                  )}
                </TouchableOpacity>
              );
            })}
...
const styles = StyleSheet.create({
  container: { flex: 1, paddingTop: Platform.OS === "web" ? 0 : 44 },
  logoContainer: {
  ...
  logoTextWrap: { flex: 1 },
  logoText: { fontSize: 14, fontWeight: "800", letterSpacing: 0.8 },
  logoSub: { fontSize: 9, marginTop: 1 },
  scroll: { flex: 1 },
  section: { paddingTop: 16, paddingHorizontal: 10 },
  sectionTitle: {
    fontSize: 9, fontWeight: "800", letterSpacing: 1.5,
    textTransform: "uppercase", marginBottom: 4, paddingLeft: 10,
  },
  menuItem: {
    flexDirection: "row", alignItems: "center", gap: 10,
    paddingVertical: 9, paddingHorizontal: 10,
    borderRadius: 9, marginBottom: 1, position: "relative",
  },
  menuText: { fontSize: 13, flex: 1 },
  activeBar: {
