        ...
        <View style={styles.headerRow}>
          <View style={styles.headerLeft}>
            <View style={styles.headerIconBox}>
              <MaterialIcons name="restaurant-menu" size={20} color="#2563eb" />
            </View>
            <View>
              <Text style={styles.title}>Request History — Full View</Text>
              <Text style={styles.subtitle}>View and track all ingredient requests for the selected date</Text>
            </View>
          </View>
        ...
        <ScrollView style={styles.body} contentContainerStyle={styles.bodyContent}>
          {loadingAllocations ? (
            ...
            <View style={styles.emptyBox}>
              <MaterialIcons name="add-shopping-cart" size={40} color="#cbd5e1" />
